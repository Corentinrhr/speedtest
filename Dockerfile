...
# >>> This project uses angular.template.json + setup-env.js to GENERATE
RUN node ./setup-env.js

# Sanity check: angular.json must exist now.
RUN test -f angular.json \
    && echo "OK: angular.json generated" \
    || (echo "FATAL: angular.json was not generated by setup-env.js" && exit 1)
